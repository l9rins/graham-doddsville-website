...
const filePath = path.join(__dirname, '../public/governance.html');
let html = fs.readFileSync(filePath, 'utf8');

// The new subtitle
const newSubtitle = 'A collection of Warren Buffett\u2019s insightful quotes on directors, management and the realities of corporate governance.';
...
if (match) {
    ...
    console.log('governance.html updated with flat accordion layout successfully!');
} else {
