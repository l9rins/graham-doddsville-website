...
const filePath = path.join(__dirname, '../public/economics.html');
let html = fs.readFileSync(filePath, 'utf8');

// The new subtitle
const newSubtitle = 'A collection of Warren Buffett\u2019s insightful quotes on inflation, international trade and the domestic and global economy.';
...
if (match) {
    ...
    console.log('economics.html updated with flat accordion layout successfully!');
} else {
