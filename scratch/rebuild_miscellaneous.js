...
const filePath = path.join(__dirname, '../public/miscellaneous.html');
let html = fs.readFileSync(filePath, 'utf8');

// The new subtitle
const newSubtitle = 'A collection of Warren Buffett\u2019s insightful quotes on miscellaneous topics ranging from love and happiness to philanthropy and success.';
...
if (match) {
    ...
    console.log('miscellaneous.html updated with flat accordion layout successfully!');
} else {
