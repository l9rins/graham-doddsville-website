...
const raw = fs.readFileSync('books.json', 'utf16le').trim();
...
function categorizeBook(title, author) {
  ...
  if (lowerAuthor.includes('graham') || lowerAuthor.includes('klarman') || lowerTitle.includes('value investing') || lowerTitle.includes('margin of safety') || lowerTitle.includes('intelligent investor')) {
    return "Value Investing";
  }
  if (lowerAuthor.includes('lynch') || lowerAuthor.includes('bogle') || lowerAuthor.includes('malkiel') || lowerTitle.includes('stock') || lowerTitle.includes('investing') || lowerTitle.includes('market wizards') || lowerTitle.includes('reminsicences')) {
  ...
  if (lowerTitle.includes('sales') || lowerTitle.includes('marketing') || lowerTitle.includes('influence') || lowerTitle.includes('sell')) {
...
fs.writeFileSync('categorized_books.json', JSON.stringify(categories, null, 2));